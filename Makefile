...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2015/11/25 15:07:44 by vcastro-          #+#    #+#              #
#    Updated: 2015/12/07 14:13:56 by vcastro-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CC=gcc -Wall -Werror -Wextra

FILESC=ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	   ...
	   ft_lstmap.c ft_lstnew.c ft_power.c ft_itoa_base.c

FILESO=ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	   ...
	   ft_lstmap.o ft_lstnew.o ft_power.o ft_itoa_base.o
